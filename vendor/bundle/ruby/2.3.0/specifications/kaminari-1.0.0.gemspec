...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<kaminari-actionview>.freeze, ["= 1.0.0"])
      s.add_runtime_dependency(%q<kaminari-activerecord>.freeze, ["= 1.0.0"])
      ...
      s.add_dependency(%q<kaminari-actionview>.freeze, ["= 1.0.0"])
      s.add_dependency(%q<kaminari-activerecord>.freeze, ["= 1.0.0"])
